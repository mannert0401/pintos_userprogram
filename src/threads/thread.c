...
thread_exit (void) 
{
  ...
  /*
     thread current's flag pr_exit makes to true.
     And semaphore makes up to finish parent's process_wait.
     And we must fix thread_schedule_tail. That function free thread's page.
     But we need exit thread structure at the parent's process wait.
     So we remove palloc_free_page at thread_schedule_tail.
  */
...
init_thread (struct thread *t, const char *name, int priority)
{
  ...
  /*
    Initilizing semaphore using at load and exit race condition and child list.
  */
